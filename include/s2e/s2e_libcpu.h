...
void s2e_register_cpu(struct CPUARMState *cpu_env);
...
void se_tb_gen_llvm(struct CPUARMState *env, struct TranslationBlock *tb);
...
void s2e_update_tlb_entry(struct CPUARMState *env, int mmu_idx, uint64_t virtAddr, uint64_t hostAddr);
